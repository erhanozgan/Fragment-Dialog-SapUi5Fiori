		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fragment Dialog",
									"targetURL": "#fragmentDialogfragmentdialog-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fragmentDialogfragmentdialog-display": {
								"semanticObject": "fragmentDialogfragmentdialog",
								"action": "display",
								"description": "Fragment Dialog SAPUI5",
								"title": "Fragment Dialog",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fragmentDialog.fragmentdialog",
									"url": sap.ui.require.toUrl("fragmentDialog/fragmentdialog")
								}
							}
						}
					}
